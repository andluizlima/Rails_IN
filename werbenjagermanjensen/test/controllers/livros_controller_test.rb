...
class LivrosControllerTest < ActionController::TestCase
  ...
  test "should create livro" do
    assert_difference('Livro.count') do
      post :create, livro: { autor: @livro.autor, qtdPaginas: @livro.qtdPaginas, sinopse: @livro.sinopse, titulo: @livro.titulo }
    end
  ...
  test "should update livro" do
    patch :update, id: @livro, livro: { autor: @livro.autor, qtdPaginas: @livro.qtdPaginas, sinopse: @livro.sinopse, titulo: @livro.titulo }
    assert_redirected_to livro_path(assigns(:livro))
  end
