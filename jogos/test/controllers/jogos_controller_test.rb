...
class JogosControllerTest < ActionController::TestCase
  ...
  test "should create jogo" do
    assert_difference('Jogo.count') do
      post :create, jogo: { estilo: @jogo.estilo, nome: @jogo.nome, preco: @jogo.preco, produtora: @jogo.produtora }
    end
  ...
  test "should update jogo" do
    patch :update, id: @jogo, jogo: { estilo: @jogo.estilo, nome: @jogo.nome, preco: @jogo.preco, produtora: @jogo.produtora }
    assert_redirected_to jogo_path(assigns(:jogo))
  end
