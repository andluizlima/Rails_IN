...
class ConsolesControllerTest < ActionController::TestCase
  ...
  test "should create console" do
    assert_difference('Console.count') do
      post :create, console: { fabricante: @console.fabricante, lancamento: @console.lancamento, midia: @console.midia, nome: @console.nome, preco: @console.preco }
    end
  ...
  test "should update console" do
    patch :update, id: @console, console: { fabricante: @console.fabricante, lancamento: @console.lancamento, midia: @console.midia, nome: @console.nome, preco: @console.preco }
    assert_redirected_to console_path(assigns(:console))
  end
